...
export const legacy_PreApprovalApplicationQuestions = [
    {
...
export const defaultApplicationQuestions = {
  start: {
        "question": "Are you buying or selling a vehicle?",
        "description": "",
        "options": ['Buy', 'Sell'],
        "type": "radio"
    },
  sell: {
        ...
        "description": "Please provide the your name and contact information, along with a note about the vehicle.",
